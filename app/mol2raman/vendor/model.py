...
# Vendored from Mol2Raman (https://github.com/salvasorrentino/Mol2Raman)
# Copyright (c) 2025 salvasorrentino — MIT License (see ./LICENSE).
#
# Unmodified copy of Scripts/script_model/model.py. These are the GNN
# architectures that must be instantiated before a trained checkpoint's
# state_dict can be loaded. Do not edit; treat as an external dependency.
import torch
